<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addcement.aspx.cs" Inherits="webapp1.addcement" %>
            ...
            <div class="content-wrapper">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <asp:TextBox ID="TextBox2" class="form-control" runat="server" placeholder="Enter Product Name"></asp:TextBox>
                        </div>
                    </div>
                    <br />
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <asp:TextBox ID="TextBox3" class="form-control" runat="server" placeholder="Enter Category"></asp:TextBox>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <asp:TextBox ID="TextBox4" class="form-control" runat="server" placeholder="Enter Type"></asp:TextBox>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <asp:TextBox ID="TextBox6" class="form-control" runat="server" placeholder="Enter Price"></asp:TextBox>
                        </div>
                    </div>
                    <br>
