        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                  ...
                  <div class="col-2">No. of CementBags</div>
                </div>
                <div class='row'>
                    <div class="col-3">
                        <asp:TextBox ID="tbpro1" class="form-control" runat="server" placeholder="Enter Product Name"></asp:TextBox>
                    </div>
                    <div class="col-2">
                        <asp:TextBox ID="tbtype1" class="form-control" runat="server" placeholder="Enter Type"></asp:TextBox>
                    </div>
                  <div class="col-2">
                        <asp:TextBox ID="tbstock1" class="form-control" runat="server" placeholder="Enter no. of Cement"></asp:TextBox>
                  </div>
                    <div class="col-2">
