<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cement_history.aspx.cs" Inherits="webapp1.cement_history" %>
          ...
          <div class="col-sm-6">
            <h1>Your History</h1>
               ...
               <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                   <Columns>
                       <asp:BoundField DataField="Dist_No" HeaderText="Dist_No" SortExpression="Dist_No"></asp:BoundField>
                       <asp:BoundField DataField="Dist_Name" HeaderText="Dist_Name" SortExpression="Dist_Name"></asp:BoundField>
               ...
               <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT [Dist_No], [Dist_Name], [Company_Name], [Product_name], [Category], [Type], [Capacity], [Price], [Number_Of_CementBags], [Amount], [Date] FROM [PurchaseHistory] WHERE ([User_No] = @User_No)">
                   <SelectParameters>
