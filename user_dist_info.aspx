<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_dist_info.aspx.cs" Inherits="webapp1.user_dist_info" %>
...
<asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
        ...
        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT DISTINCT [Dist_No], [Dist_Name], [Company_Name] FROM [PurchaseHistory] WHERE ([User_No] = @User_No)">
            <SelectParameters>
