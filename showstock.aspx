<%@ Page Language="C#" AutoEventWireup="true" CodeFile="showstock.aspx.cs" Inherits="webapp1.showstock" %>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="card-body">
                        ...
                        <asp:Panel class="row" ID="Panel1" runat="server">
                          <!-- 
                          <div class="col-lg-3 col-6">
                                <div class="info-box">
                                    <div class="inner">
                                        <h4>
                                            <asp:Label ID="lblname1" runat="server" Text="Label">Bounce Rate</asp:Label></h4>
                                        <h5>
                                            <asp:Label ID="lblno1" runat="server" Text="Label">53</asp:Label></h5>
                                    </div>
                                </div>
                            </div>
                            -->
